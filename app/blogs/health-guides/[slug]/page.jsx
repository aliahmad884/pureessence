...
export default function BlogSlug({ params }) {
    ...
    useEffect(() => {
        ...
        const fetchBlog = async () => {
            ...
            if (cachedData) {
                let find = cachedData.find(b => b.bSlug === decodedSlug && b.bCategory === 'Health-Guide')
                setBlog(find)
                setIsLoading(false)
                    ...
                    <div className="readerCont">
                        <div className="readerHeader">
                            ...
                            <div className="postHeader">
                                <p>Published: {new Date(blog.date).toDateString()} in <Link href={'/blogs/health-guides'}>Health Guides</Link></p>
                                <h1>{blog.bTitle}</h1>
